...
export const setSyncedValueRegistrySource = Symbol.for(
  "dreamlab.internal.setSyncedValueRegistrySource",
);
export const behaviorScriptLoader = Symbol.for("dreamlab.internal.behaviorScriptLoader");
